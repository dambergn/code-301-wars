...
The Code Wars challenge will be posted at end of each class and will be due before start of the next class. 


### Whiteboarding

You will be working with a new partner every day for whiteboarding. This will also be your partner for the paired lab.

Plan on getting together with your partner and read through the challenge. There are several items to accomplish, as time allows:
...
As part of today's assignment, create a new repository on GitHub to track your Code Wars solutions throughout 301, e.g. 'code-301-wars'. This repo should have a README.md file with an overview of the purpose of the repo.
